					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload FI document",
									"targetURL": "#zupfi-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zupfi-display": {
								"semanticObject": "zupfi",
								"action": "display",
								"description": "Upload FI document",
								"title": "Upload FI document",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zupfi",
									"url": sap.ui.require.toUrl("zupfi")
								}
							}
						}
					}
